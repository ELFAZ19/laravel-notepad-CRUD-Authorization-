<x-app-layout :title="$title">
    ...
    <div class="max-w-2xl mx-auto sm:px-6 lg:px-8 p-4">
        <!-- Header Row: Edit Note title and Back button -->
        ...
        <!-- Form -->
        <form method="post" action="{{ route('note.update',$note) }}" class="space-y-6 max-w-2xl mx-auto">
            @csrf
            @method('PATCH')
            <div>
            ...
            <div>
                ...
                <x-textarea-input id="body" name="body" class="mt-1 block w-full">{{ old('body', $note->body) }}</x-textarea-input>
